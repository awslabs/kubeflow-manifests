...
If you want to set up application load balancing (ALB) with Dex, see the [Load Balancer]({{< ref "/docs/add-ons/load-balancer/guide.md" >}}) guide and use the ALB address as the Kubeflow Endpoint.
