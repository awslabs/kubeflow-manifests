...
1. Follow the [section 4.0(Building manifests and deploying Kubeflow)]({{< ref "/docs/deployment/cognito/guide.md#40-building-manifests-and-deploying-kubeflow" >}}) to install Kubeflow
