...
{{< /tab >}}
{{< /tabpane >}}
1. Follow the rest of the Cognito guide from [section 4.0 (Updating the domain with ALB address)]({{< ref "/docs/deployment/cognito/manifest/guide-automated.md#40-updating-the-domain-with-alb-address" >}}) in order to:
