...
There are a number of deployment options for installing Kubeflow with AWS service integrations. For detailed instructions regarding available AWS-integrated deployment options, see the [deployment guides](https://awslabs.github.io/kubeflow-manifests/deployments/) on the [Kubeflow on AWS](https://awslabs.github.io/kubeflow-manifests/) website.
