...
export CANARY_TEST_DIR=${REPO_PATH}/distributions/aws/test/canary
export E2E_TEST_DIR=${REPO_PATH}/distributions/aws/test/e2e
...
cd $E2E_TEST_DIR
pytest tests/test_sanity.py -s -q --metadata .metadata/metadata-canary --keepsuccess --region $CLUSTER_REGION
