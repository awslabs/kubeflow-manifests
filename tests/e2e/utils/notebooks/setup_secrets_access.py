...
SECRETS_MANAGER_KUSTOMIZE_FILE_BASE_PATH = (
    f"{AWS_CONFIGS_PATH}common/aws-secrets-manager/"
)
SECRETS_MANAGER_KUSTOMIZE_FILE_PATH = (
    f"{SECRETS_MANAGER_KUSTOMIZE_FILE_BASE_PATH}kustomization.yaml"
)
...
def setup_secrets_manager_kustomize():
    ...
    secrets_manager_kustomize_content = load_yaml_file(
        SECRETS_MANAGER_KUSTOMIZE_FILE_PATH
    )
...
def edit_secrets_manager_kustomize(edit_secrets_manager_kustomize_content, namespace):
    ...
    write_yaml_file(
        edit_secrets_manager_kustomize_content, SECRETS_MANAGER_KUSTOMIZE_FILE_PATH
    )
