...
class S3BucketForKServe:
    """
    Encapsulates S3BucketForKServe functions.
    """
    ...
    def create(self):
        try:
            ...
            cmd = f"aws s3 sync ../../serving/tensorflow_serving/servables/tensorflow/testdata/saved_model_half_plus_two_cpu s3://{self.name}/saved_model_half_plus_two".split()
