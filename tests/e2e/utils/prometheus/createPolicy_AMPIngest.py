...
PERMISSION_POLICY_FILE_PATH = (
    "../../deployments/add-ons/prometheus/AMPIngestPermissionPolicy"
)


def create_AMP_ingest_policy():
    return create_policy_if_not_exist(
        SERVICE_ACCOUNT_IAM_AMP_INGEST_POLICY, PERMISSION_POLICY_FILE_PATH
    )
