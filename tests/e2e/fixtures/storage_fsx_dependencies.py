...
def static_provisioning(metadata, region, request, cluster):
    ...
    fsx_pv_filepath = "../../deployment/add-ons/storage/fsx-for-lustre/static-provisioning/pv.yaml"
    fsx_pvc_filepath = "../../deployment/add-ons/storage/fsx-for-lustre/static-provisioning/pvc.yaml"
