...
class TestPrometheus:
    ...
    def setup(self, metadata, prometheus_amp):
        ...
        print(
            f"PROMETHEUS_PRINT: Got Initial value of the prometheus query: "
    ...
    def test_istio_request_count(self, setup, region, kfp_client):
        ...
        # fixture.
        print(
            f"PROMETHEUS_PRINT: About to check the post-create istio request "
    ...
    def test_kfp_experiment(self, setup, region, kfp_client):
        ...
        prometheus_kfp_experiment_count_query = (
            "experiment_server_create_requests" '\\{job="ml-pipeline"\\}'
        )
        initial_kfp_experiment_count = int(
            get_prometheus_query_results(prometheus_kfp_experiment_count_query)
        )
        ...
        print(
            f"PROMETHEUS_PRINT: About to check the post-create kfp experiment "
    ...
    def test_katib_experiment(self, cluster, region):
        ...
        prometheus_katib_experiment_count_query = (
            "katib_experiment_created_total" '\\{job="katib-controller"\\}'
        )
        ...
        print(
            f"PROMETHEUS_PRINT: About to check the post-create katib "
    ...
    def test_notebook(self, cluster, region):
        ...
        prometheus_notebook_count_query = (
            "notebook_create_total" '\\{namespace="profile-aws-iam"\\}'
        )
        ...
        notebook_server_pvc_spec_file = (
            TO_ROOT_PATH + "tests/e2e/resources/custom-resource-templates/"
        ...
        print(
            f"PROMETHEUS_PRINT: About to check the post-create notebook "
        ...
        subprocess.call(f"kubectl delete -f {notebook_server_pvc_spec_file}".split())
