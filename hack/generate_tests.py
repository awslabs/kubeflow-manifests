...
SEARCH_DIRS = [
    ...
    "apps/jupyter/jupyter-web-app",
    "apps/katib/upstream/installs/katib-external-db-with-kubeflow",
    "distributions/aws/aws-secrets-manager",
    "distributions/aws/aws-alb-ingress-controller",
    "distributions/aws/aws-istio-envoy-filter",
]
...
def run_kustomize_build(repo_root, package_dir):
    ...
    output_dir = os.path.join(
        repo_root, "tests", rpath, KUSTOMIZE_OUTPUT_DIR)
