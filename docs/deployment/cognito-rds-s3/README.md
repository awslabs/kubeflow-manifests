...
## 1. Prerequisites
Follow the pre-requisites section from [this guide](../rds-s3/README.md#10-prerequisites) and setup RDS & S3 from [this guide](../rds-s3/README.md#20-setup-rds-s3-and-configure-secrets) to:
