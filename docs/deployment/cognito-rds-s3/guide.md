...
## 1. Prerequisites
Refer to the [general prerequisites guide](/docs/deployment/prerequisites/) and the [RDS and S3 setup guide](/docs/deployment/rds-s3/guide/) in order to:
...
1. Follow the [Cognito setup guide](/docs/deployment/cognito/guide/) from [Section 1.0 (Custom domain)](/docs/deployment/cognito/guide/#10-custom-domain-and-certificates) up to [Section 3.0 (Configure ingress)](/docs/deployment/cognito/guide/#30-configure-ingress) in order to:
...
2. Deploy Kubeflow. Choose one of the two options to deploy kubeflow:
    ...
    1. **[Option 2]** Install individual components:
        ...
        ```
1. Follow the rest of the Cognito guide from [section 5.0 (Updating the domain with ALB address)](/docs/deployment/cognito/guide/#50-updating-the-domain-with-ALB-address) in order to:
